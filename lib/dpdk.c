...
static bool tso_support = false;      /* TSO support */
...
dpdk_init__(const struct smap *ovs_other_config)
{
    ...
    tso_support = smap_get_bool(ovs_other_config,
                                    "tso-support", false);
    VLOG_INFO("TSO support for vhost user client devices %s.",
              tso_support ? "enabled" : "disabled");
